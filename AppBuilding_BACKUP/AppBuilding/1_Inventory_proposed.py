...
# ==================================
st.set_page_config(
    page_title="LION Inventory Management",
    page_icon="📦",
    layout="wide"
)
...
with tab1:
    ...
    if selected_prod != "-- Choose Product --":
        ...
        with col_op:
            # Let opening quantity be viewable/editable
...
with tab2:
    ...
    # Side-by-side Add, Delete, and Update Actions
        ...
        with st.form("add_forecast_form", clear_on_submit=True):
            ...
            if btn_add_f:
                if not new_f_name.strip():
                    ...
                    # Calculate recommended order & status
    ...
    with col_act2:
        ...
        if selected_f_prod != "-- Choose Product --":
            ...
            # Sub-form to update stock level
